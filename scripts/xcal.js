(function () {
    ...
    var def = {
        ...
        autoOn: 1, autoOff: 0, now: 0, set0: 0, x: 0, hide: 0, to: "", fn: ""
    }
    ...
    window.xCal = function (ob, delim, order) { // xCal(this,'-',1) // xCal() == close
        ...
        xCal.f = function (a) {
            ...
            HTM(a.id, '<thead><tr><td class="cal-l" title="' + lang[a.lang].pre + '">Пред </td><td colspan=3 class="cal-m"></td><td colspan=2 class="cal-y"></td><td class="cal-r" title="' + lang[a.lang].nex + '"> След</td></tr><tr><td>' + lang[a.lang].w + '</td></tr></thead>');

            if (j > 0) {// вЂ№ &larr;
                if (m == 0) mm = 11; else mm = m - 1;
                if (j > 1) {
                    ca += '<td colspan=' + j + ' class="cal-l" align=left title="' + lang[a.lang].pre + ' ' + lang[a.lang].mo[mm] + '"><b>Пред ' + lang[a.lang].m[mm] + '</b></td>';
                } else ca += '<td class="cal-l" title="' + lang[a.lang].pre + ' ' + lang[a.lang].mo[mm] + '"><b> След</b></td>';
            }
            ...
            if (DNlast > 0) {// вЂє &rarr;
                ...
                if (DNlast < 6) {
                    ca += '<td colspan=' + (7 - DNlast) + ' class="cal-r" align=right title="' + lang[a.lang].nex + ' ' + lang[a.lang].mo[mm] + '"><b>' + lang[a.lang].m[mm] + ' След</b></td>';
                } else ca += '<td class="cal-r" title="' + lang[a.lang].nex + ' ' + lang[a.lang].mo[mm] + '"><b> След</b></td>';
            }
